...
- SSO一般就是独立的账户管理授权登陆系统，当用户通过浏览器访问其中一个业务时(CAS系统)
	...
	- 登陆后创建SSO session, CASTGC Cookie包含TGT(Ticket Granting Ticket), TGT是SSO session的session  key
	- 重定向到业务，url上带有service ticket number，cookie被设置为CASTGC cookie
	- 此时用户访问业务中受保护的资源的时候，业务server会去向SSO server申请验证service ticket
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjc4NjU5MjgsNzE4ODkzMDI2LDE5Nz
YwNzU5OTgsMTk4NTE2ODc5MSwtMjAzNzgxNTM4MywtNTQ2NjM0
MTU0LC00NTk5Nzk3NjZdfQ==
-->