...
- SSO一般就是独立的账户管理授权登陆系统，当用户通过浏览器访问其中一个业务时
	- 业务检查是否登陆
	- 没有登陆的话重定向到SSO server， 带上业务url地址
	- SSO  Server判断用户是否有SSO session
	- 没有SSO session的话就让用户登陆认证
	- 登陆后创建SSO session, CASTGC Cookie包含TGC(Ticket Granting Ticket), TGC是SSO session的session  key
	- 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgwMzg4OTY5MSw3MTg4OTMwMjYsMTk3Nj
A3NTk5OCwxOTg1MTY4NzkxLC0yMDM3ODE1MzgzLC01NDY2MzQx
NTQsLTQ1OTk3OTc2Nl19
-->