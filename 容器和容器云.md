...
- pod里面所有的容器都共享同一个network namespace，并且可以声明共享同一个volume 
	...
	- pod里可见容器都可以通过localhost通信，它们看到的网络设备跟Infra一致，一个pod只有一个IP地址，它的所有网络资源都是里面所有容器共享的，所有容器的进出流量都是由Infra操作的，如果需要开发一个网络插件，应当考虑如何配置pod的networ
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3NDg3MzA1MSwtNTQ1ODUwMTgsLTE3Mz
Q2NzE3NTksMTk5MzMxMjA3NSwtMTc3MjcyMDYsLTUzMDk3NzU3
MCwtMTkxNzkzMjY0MywxNjEyNDAzMDIsLTEzMzMzMzYwOTYsMT
A4NDc4NTAzMiw4NTE3MzcxMTgsMTAzNTUyMDY3OCw4Njg0ODU3
MjQsMTUwODIyNjQ1OCwtMjAwMzY5MDM5NSwxMTY4NjU3MjA0LD
E2OTIzMjIzOSwtMzMzODE2NjkxLC0xODM4NzQ1NDMxLC0xOTM0
MTA1NjE3XX0=
-->