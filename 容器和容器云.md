...
- 蓝绿/红黑/AB部署
	- 滚动部署，应用的新版本逐步替换旧版本
	- 有两个相同的环境并行部署，一个当前运行的环境(蓝)，接收所有的用户流量，另一个是它的副本(绿)，闲置，部署新的版本，一旦通过测试，将流量接入副本环境，副本环境变成新的she
- 灰度发布

[发布模式实验](https://github.com/ContainerSolutions/k8s-deployment-strategies/tree/master/canary)
## 服务发现
### Service
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0Njg2ODgwMCwyMTI5MDU0NjMzLC0xNz
E1NTAxNTA5LC0xOTMxNjQ1MTYyLDEyMDIzNjUzNjcsMzQyNTQz
Nzk1LDczMDQ2MTc1NCwxOTg0MTEzMzg3LC0zOTkxOTY2MzQsLT
E5OTg5Mjk0NDksMjAzNjc3MDU5NiwtMjY5MDI4MTY0LDEwODY5
MjY2MDksMTQ3MzQ1MjczNCwtMTc3NzMyNTgzOCwxMjE1MzE5Mj
M3LC0xODQ0NTY4OTI3LDEzMDI3OTkwOTEsLTI0OTMyMjczNSwx
MTUxMTYwMTUzXX0=
-->