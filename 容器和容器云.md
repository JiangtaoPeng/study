...
- ![镜像层](https://www.mobilefish.com/images/developer/docker_ubuntu_layers.gif)
- copy-on-write: 修改base image的文件内容时，由于base image层只读，所以先复制到读写层后修改
...
# Kubenetes
- 过去很多集群管理项目(Swarm, mesos, yarn等)所擅长的就是把一个容器按照某种规则，放置在某个最佳节点上运行起来 -> 调度

- kubenetes是按照用户的意愿和整个系统的规则，完全自动化的处理好容器之间的关系 -> 编排

### pod
- 容器本质是进程
- kubenetes就是操作系统
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzNjg4NTU1NCwxNTA4MjI2NDU4LC0yMD
AzNjkwMzk1LDExNjg2NTcyMDQsMTY5MjMyMjM5LC0zMzM4MTY2
OTEsLTE4Mzg3NDU0MzEsLTE5MzQxMDU2MTcsMTU2MjQwOTc4MS
wtMTYzMDYzMzEwMCwxNzg0MTAxNDQzLC0xNTk3MzQwNTExLC00
NjQwMjM4OTgsMTkxNjEyMTYxOSwyMDI3NzQ5MjM3LC0xMjA5Mz
k0NzQ2LDUxMTEwNjYwMCwtNjA0NDU4NTE3LDEwNDA2NTcxMzAs
MTExMjY3MTEwN119
-->