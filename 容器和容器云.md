...
- 隔离
	...
	- [Namespace](https://lwn.net/Articles/531114/)
		- 六种Namespace: Mount Namespace(挂载点), UTS Namespace(主机名与域名), IPC Namespace(信号量，消息队列和共享内存), PID Namespace, Network Namespace, User Namespace
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNzc0OTIzNywtMTIwOTM5NDc0Niw1MT
ExMDY2MDAsLTYwNDQ1ODUxNywxMDQwNjU3MTMwLDExMTI2NzEx
MDcsLTIxMjc4MTQzODYsLTExNTEzNTU1MzAsMTc2NDcwNzEzLC
0xNjc2ODAxNTMwLDcwMjM5MDE5MCwxNzg2NTgwOTddfQ==
-->