    ...
    |-->__alloc_pages_nodemask
       ...
       |--> __alloc_pages_slowpath
           ...
           |--> __alloc_pages_may_oom
              ...
              | --> out_of_memory   //触发
```
```__alloc_pages_may_oom()在调用之前会先判断oom_killer_disabled的值，如果有值，则不会触发OOM机制；
...
原文链接：https://blog.csdn.net/s_lisheng/article/details/82192613
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzA3NjM0Nzk3LDE0MDIyODI1NTEsLTE1Nj
gwNjcxMV19
-->